...
<div class="glass-card p-6 rounded-2xl">
    <div class="flex items-center justify-between mb-4">
        <h2 class="text-2xl font-bold text-black"><x-icon name="upload" class="inline-block mr-2 w-6 h-6"/>Laporan Stok Keluar</h2>
        <div class="flex items-center space-x-2">
            ...
            <a href="{{ route('reports.out') }}" class="btn-cream text-black">Reset</a>
        </div>
    </div>
